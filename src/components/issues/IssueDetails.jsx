...
const IssueDetails = () => {
  ...
  console.log("issues",selectedIssue);

console.log("issueDetail",selectedIssue?.submittedBy)
    ...
    <div>
      ...
      <div className="Details px-4">
        ...
        <p className="font-mono text-gray-500 font-medium text-[13px]">
          Posted by {selectedIssue?.submittedBy}{" "}
          <span className="font-bold text-xl px-1">.</span>
          {formatTimeAgo(selectedIssue?.createdAt)}
        </p>
        <h4 className="font-mono font-medium text-[15px] mt-1">
      ...
      <CommentSection postId={id} currentUser={selectedIssue?.submittedBy} />
    </div>
  );
};
